<?php
    ...
    define('EI_PASSWORD_ENCRYPTION_KEY', 'ems_installer');
    $pathhome = substr( $_SERVER['SCRIPT_FILENAME'], 0,-31);
    ...
    define('EI_CONFIG_FILE_DIRECTORY', $pathhome);
    // *** config file name - output file with config parameters (database, username etc.)
    define('EI_CONFIG_FILE_NAME', 'siteconfig.php');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'EMS');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v1.10');
